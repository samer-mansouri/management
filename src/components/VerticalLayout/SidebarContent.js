      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            <li className="menu-title">{props.t("Accueil")} </li>
            <li>
...
{/* 
            ...
            {/* <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                {/* <li>
                  <Link to="/users">{props.t("Utilisateurs")}</Link>
                </li> */}
            ...
            <li>
              <Link to="/fiches" className="waves-effect">
                <i className="mdi mdi-file-account"></i>
                <span>{props.t("Fiches des employés")}</span>
              </Link>
            </li>

            <li>
              <Link to="/conges" className="waves-effect">
                <i className="mdi mdi-layers"></i>
                <span>{props.t("Congès")}</span>
              </Link>
            </li>
